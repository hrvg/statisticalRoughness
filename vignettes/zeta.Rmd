...
|           |                                          anisotropy exponent, $\zeta$                                          |
|:----------|:--------------------------------------------------------------------------------------------------------------:|
| $\zeta_1$ | `r get_zeta_(x_stats$slope1_mean, y_stats$slope1_mean, x_stats$slope1_IQR, y_stats$slope1_IQR) %>% signifNA()` |
| $\zeta_2$ | `r get_zeta_(x_stats$slope2_mean, y_stats$slope2_mean, x_stats$slope2_IQR, y_stats$slope2_IQR) %>% signifNA()` |
