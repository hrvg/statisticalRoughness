...
res_gabi <- get_zeta(gabilan_mesa, raster_resolution, .mode = "radial") %>% dplyr::mutate_all(signifNA)
```
...
res_yose <- get_zeta(yosemite, raster_resolution, .mode = "radial") %>% dplyr::mutate_all(signifNA)
```
...
res_modo <- get_zeta(modoc, raster_resolution, .mode = "radial") %>% dplyr::mutate_all(signifNA)
```
...
res_mrbl <- get_zeta(marble_canyon, raster_resolution, .mode = "radial") %>% dplyr::mutate_all(signifNA)
```
...
res_subm <- get_zeta(submarine_canyon, raster_resolution, .mode = "radial") %>% dplyr::mutate_all(signifNA)
```
